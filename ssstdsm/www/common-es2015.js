...
let SlidesService = class SlidesService {
    constructor(db) {
        ...
        this.slides = this.slidesCollection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(actions => {
    ...
    getSlidesByType(type) {
        return this.slides.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(s => s.filter(x => x.slideType === type && x.isActive).sort(x => x.order)));
    }
};
SlidesService.ctorParameters = () => [
    { type: angularfire2_firestore__WEBPACK_IMPORTED_MODULE_2__["AngularFirestore"] }
];
SlidesService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
